      ...
      <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 gap-8 md:gap-16 mt-8 md:mt-20">
        <div className="flex flex-col justify-center">
          ...
          <p className="mb-4 text-sm md:text-base">
            ...
            gradien/slope/koefisien arah/kemiringan b = intercept (titik potong
            fungsi sumbu y) Nah, fungsi linear ini tidak akan jauh dari yang
            namanya penggambaran grafik, sehingga ketika harus melakukannya
            harus mencermati beberapa langkah berikut ini.
          </p>
          <ul className="list-disc ml-6 text-sm md:text-base">
            ...
            <li>
              Apabila b bernilai positif, maka fungsi linear akan dilukis garis
              dari arah kiri bawah ke kanan atas.
            </li>
            <li>
              Apabila b bernilai negatif, maka fungsi linear akan dilukis garis
